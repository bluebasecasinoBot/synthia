    ...
    return __c(
        ...
        [
            __c(
                ...
                [
                    __SYD.ul_lists_el({child:__SYD.pTag({text:"Use Agent" , class_:"clickButton" , style:`${!__p(["userAgentAi__sections_main" , "agentVerification"],false) ? "pointer-events:none;opacity:.4;" : "pointer-events:auto;"}` + SYD_VAR.buttonStyle1.get() + `display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "none" : "auto"};`}) , function_:{
                        onclick:() =>{
                    ...
                    __SYD.ul_lists_el({child:__SYD.pTag({text:"Edit Agent" , class_:"clickButton" , style:`${!__p(["userAgentAi__sections_main" , "agentVerification"],false) ? "pointer-events:none;opacity:.4;" : "pointer-events:auto;"}` + SYD_VAR.buttonStyle1.get() + `display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "none" : "auto"};`}) , function_:{
                        onclick:() =>{
                            if(__p(["userAgentAi__sections_main" , "agentVerification"],false))
                            {
